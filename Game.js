...
// maam if we talk for 1st player then if has shot 15 bullets then they should be updated in datanase and get
// value so if his count is 15 so his gs should change for other players they will not get the value till 
//the time they line 190 not get true ie even one bullet of their group should touch to get the value of 
//count but for ist player who shot 15 bullet his line 190 is true ie his bullet group is atleast touched
// sohe will get count value from databse and update it too so if he got value 15 from database his gs should 
//change irrespective of others as others have to shot even one bullet to make condition true and get value.
...
// making player life again as 3
    player.life = 3;
   player.update();
// when player touch the enemy they hould get their life reduced
